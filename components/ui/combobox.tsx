...
function ComboboxInput({
  ...
  return (
    <InputGroup className={cn("w-auto shadow-none", className)}>
...
function ComboboxItem({
  ...
  return (
    <ComboboxPrimitive.Item
      ...
      className={cn(
        "data-highlighted:bg-accent data-highlighted:text-accent-foreground not-data-[variant=destructive]:data-highlighted:**:text-accent-foreground gap-2 rounded-sm py-1.5 ltr:pr-8 ltr:pl-2 rtl:pr-2 rtl:pl-8 text-sm [&_svg:not([class*='size-'])]:size-4 relative flex w-full cursor-default items-center outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className,
      )}
      {...props}
    >
      ...
      <ComboboxPrimitive.ItemIndicator
        render={
          <span className="pointer-events-none absolute ltr:right-2 ltr:left-auto rtl:right-auto rtl:left-2 flex size-4 items-center justify-center" />
        }
      >
