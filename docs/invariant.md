invariant           marketna
Database password   hEFo6ag2MU6R4dm5
...
File: .env.local
```
NEXT_PUBLIC_SUPABASE_URL=https://kgvgqznqxxflpgewwgpo.supabase.co
NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY=sb_publishable_uQtagfb8ouluCFroyLx2zg_PY4c9RdM
```
